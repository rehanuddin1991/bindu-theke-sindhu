...
const CollectionsImages = () => {
  return (
    <div className='  mt-6 gap-8 bg-[white] items-center justify-center grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-2'>
          <div className="mx-auto mt-2 mb-2 relative card bg-base-300 w-64 sm:w-96 md:w-96 lg:w-96 shadow-xl min-h-[540px]">
              <figure>
                  <img
                      src={a1}
                      alt="Shoes" />
           ...
           sm:w-96 md:w-96 lg:w-96 shadow-xl min-h-[540px]">
              <figure>
                  <img
                      src={a2}
                      alt="Shoes" />
